  ...
  return (
    ...
    <div className='bg-chooseus-background h-fit pb-5 px-[23px]'>
      ...
      <div className="flex flex-col justify-center items-center  gap-[19]">
        ...
        <p className='text-[#5E6978] font-montserrat font-medium leading-[19.2px] tracking-[0.32px] text-center text-[14px] '>Choose Excellence, Embrace Expertise – Elevate Your Learning Journey with Us!</p>
      </div>


      <div className="flex mt-[37px] flex-col lg:flex-row ">
        <div className="lg:w-2/5 bg-gray-300 ">
        ...
        <div className="lg:w-3/5 bg-gray-500 flex flex-col lg:flex-row gap-[16px] m-auto" >

          <div className="flex gap-[16px] mt-[45px] lg:flex-col">
