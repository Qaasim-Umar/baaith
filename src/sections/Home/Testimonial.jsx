    ...
    return (
        <div className='bg-testimonial-background h-auto pb-[106px]'>
            ...
            <div className="flex flex-col justify-center items-center pt-[70px] pb-[37px] gap-[19]">
                ...
                <p className='text-[#5E6978] text-[14px] lg:text-[16px] font-montserrat font-medium leading-[19.2px] tracking-[0.32px] px-[13px] text-center'>Discover What Our Students  Have to Say – Real Stories, Real Transformations, Real Testimonials...</p>
            </div>




<div className='flex gap-4 items-center justify-center overflow-scroll'>
